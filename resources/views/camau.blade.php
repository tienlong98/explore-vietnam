...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12 mt-5">
                <h1 class="mt-5 fs-3">{{ __('カマウ水上マーケットはどこ？') }}</h1>
                <!-- <h1 class="ms-5">such place</h1> -->
                <p class="mt-5">{{ __('カマウ水上マーケットは、カマウ市の中心部、8 区のガンハオ橋から約 200 メートル、ガンハオ川の端に位置している。 カマウ水上マーケットは、西部の他の水上マーケットと同じくらいにぎやかである。 ここには何百ものボートがあり、大小さまざまなボートが商品でいっぱいで、ここで交換したり取引したりできる。 この市場がいつ形成されたのかは誰にもわかりませんが、長い間、この市場は特にカマウとサザンリバー地域全般の独特の文化的特徴となっている。') }}</p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mt-5">
                ...
                <p class="mt-3">
                {{ __('カマウ水上マーケットでは、食品、日用品、果物から、トレーダー向けの新鮮な農産物や園芸野菜の卸売購入まで、あらゆる種類の商品を販売している。機会があれば、ガンハオ川のこの特別な市場への訪問におすすめ、太陽の光、風、川、そしてここの人々のシンプルさと誠実さが、リバー ガーデンの豊かな産物と混ざり合い、忘れられない印象を残される。') }}</p>
                <div class="d-flex justify-content-center mt-5">
